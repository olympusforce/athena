...
- Singular for specific items: `src/auth/`, `.athena/docs/`
- No abbreviations: `configurations/` not `configs/` (exception: well-known like `.athena/docs/`, `src/`)
