...
const PostDataGrid = React.lazy(() => import('./grids/post-data-grid'));
...
const MyPage = lazy(() => import('~modules/my-module/ui/my-page'));
...
import type { MyData } from '~entities/my-data/model/my-data.type';
...
5. Import aliases (@/, ~shared, ~entities, ~modules)
