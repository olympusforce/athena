...
```html
<section class="flex flex-row">Row (default)</section>
<section class="flex flex-col">Column</section>
<section class="flex flex-row-reverse">Reverse row</section>
<section class="flex flex-col-reverse">Reverse column</section>
```
...
```html
<section class="grid grid-cols-1">1 column</section>
<section class="grid grid-cols-2">2 columns</section>
<section class="grid grid-cols-3">3 columns</section>
<section class="grid grid-cols-4">4 columns</section>
<section class="grid grid-cols-12">12 columns</section>
<section class="grid grid-cols-[1fr_500px_2fr]">Custom</secti>
```
