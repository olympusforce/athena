...
- Follow project docs in `.athena/docs/` and existing local patterns.
...
- Use `/athena:preview` only when a visual explanation will materially help the user understand the change.
